...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .sidebar, .header-content, .receipt-actions {
                display: none;
            }
...
<body>
    ...
    // Function to generate PDF (this is a placeholder - you would need a PDF library)
    function generatePDF() {
        alert('PDF download functionality would be implemented with a library like jsPDF or html2pdf');
